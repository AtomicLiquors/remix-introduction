...
export default function GridWithFarLeftItem({className, left, up, down}: GridWithFarLeftItemProps) {
  return (
    <div className={`grid grid-cols-[auto_1fr] grid-rows-[auto_1fr]  ${className}`}>
