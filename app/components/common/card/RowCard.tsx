...
const RowCard: React.FC<RowCardProps> = ({ children, imgSrc }) => {
  return (
    <div className="p-4 flex justify-center">
      <div className={`${themeClasses.bg.card} w-full lg:w-5/6 shadow-md border-r border-b border-l border-gray-200 p-4 flex flex-col lg:flex-row-reverse justify-between leading-normal`}>
        {imgSrc && (
