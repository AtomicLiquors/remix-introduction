...
export const projectData: ProjectProps[] = [
    {
        ...
        teamSize: 5,
        description: "뮤지션들이 연주 영상들을 공유하고, 연주 영상을 조합해 합주 영상을 제작하는 서비스",
        technologies: ["React.js", "SpringBoot", "Vite.js", "Zustand", "Styled-Component"],
        role: "Front-end",
        responsibilities: [
    ...
    },
    {
        ...
        teamSize: 2,
        description: "관광지 공공데이터 기반 여행 계획 작성, 포토 리뷰 기능을 제공하는 여행 정보 커뮤니티 서비스",
    ...
    {
        title: "🐶 모바일 AR 반려견 양육 시뮬레이션 : 세나보 - 세상에 나쁜 보호자는 있다",
