...
const TLItemTitle: React.FC<TLItemTitleProps> = ({ title, icon, color }) => {
  return (
    ...
    >
      <div className="lg:absolute flex items-center justify-center min-w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
        <FontAwesome
          icon={icon}
          color={color}
        />
